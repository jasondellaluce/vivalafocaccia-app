...
class LocalCategoryRepository implements CategoryRepository {
  ...
  List<Future<Category>> getMany(
      {offset: 0, count: 11, order: CategoryOrder.importance}) {
    return _innerList
        .sublist(offset, count)
