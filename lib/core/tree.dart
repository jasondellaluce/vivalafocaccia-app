...
class Tree<T> {
  ...
  /// no parent.
  factory Tree.fromListWithParentId(List<T> valueList,
      TreeValueIdGetter<T> idGetter, TreeParentIdGetter<T> parentIdGetter) {
    ...
    for (var tree in treeList) {
      ...
      treeList
          .firstWhere((e) => idGetter(e.value) == parentId, orElse: () => root)
          .children
          .add(tree);
    }
    return root;
